...
export default function ZigzagconversionPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      const localStorageAlgorithm = LocalStorageManager.loadAlgorithm("zigzag-conversion")
      ...
      LocalStorageManager.markAlgorithmAsUsed("zigzag-conversion")
    }
  }, [])
                    ...
                    <>
                      {selectedVisualization === 'mermaid' && (
                        <MermaidAnimation
                          ...
                          algorithmId={algorithmData.id || "zigzag-conversion"}
                        />
                      )}
