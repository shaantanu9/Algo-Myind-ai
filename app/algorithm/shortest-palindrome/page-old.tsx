...
const ALGORITHM_DATA: AlgorithmData = {
  ...
  "explanation": "Efficient Shortest Palindrome via Reversal and Slicing"
},
  animation: {
    interactiveData: {
...
export default function ShortestpalindromePage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      const localStorageAlgorithm = LocalStorageManager.loadAlgorithm("shortest-palindrome")
      ...
      LocalStorageManager.markAlgorithmAsUsed("shortest-palindrome")
    }
  }, [])
                    ...
                    <>
                      {selectedVisualization === 'mermaid' && (
                        <MermaidAnimation
                          ...
                          algorithmId={algorithmData.id || "shortest-palindrome"}
                        />
                      )}
